									...
									<div class="col-lg-6 col-md-12">
										<form method="POST" enctype="multipart/form-data">
											<div class="heading-bx left">
												...
												<?php if ($content_id == 4) { ?>
													<center><img src="../assets/images/<?php echo $web_icon; ?>.png" id="display-img" style="width: 200px; height: 200px; border-radius: 50%;"></center>
												...
												<?php }
													...
													<a href="" class="btn blue radius-xl" style="float: left;background-color: <?php echo $primary_color; ?>"><i class="ti-marker-alt"></i><span>&nbsp;&nbsp;EDIT DETAILS</span></a>
												<?php } ?>
											</div>
										</form>			
									</div>
