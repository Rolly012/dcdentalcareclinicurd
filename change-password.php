<?php
	...
	if (isset($_POST['save_pass'])) {
		...
		$model = new Model();
		$model->changePatientPassword($patient_id, $cpass, $newpword);	
	}
?>
<!DOCTYPE html>
<html lang="en">
		...
		<main class="ttr-wrapper" style="background-color: #FBFBFB;">
			<div class="container-fluid">
				<div class="db-breadcrumb">
					<h4 class="breadcrumb-title">Security</h4>
					<ul class="db-breadcrumb-list">
						<li><i class="ti-lock"></i>Change Password</li>
					</ul>
				</div>  
					...
					<div class="col-lg-12 m-b30">
						<br>
							<div class="heading-bx left">
								<h2 class="m-b10 title-head">Change <span>Password</span></h2>
							</div>
								...
								<form class="edit-profile" method="POST">
									...
									<div class="row">
										...
										<div class="col-sm-7">
											...
											<button name="save_pass" type="submit" class="btn green radius-xl" style="color: white;"><i class="ti-lock"></i> Save changes</button>
