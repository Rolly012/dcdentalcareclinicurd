							...
							<div class="row placeani">
								...
								<div class="col-lg-12">
									<div class="form-group form-forget">
										...
										<a href="patient.php" class="ml-auto">Patients Login</a>
									</div>
								</div>
								<div class="col-lg-12 m-b30">
									...
									?>
									<br><hr><center><a href="index.php" class="ml-auto">Back to Homepage</a></center> 
								</div>
							</div>
						</form>
					</div>
...
<?php
												$status = 2;
												$rows = $model->displayReservationsXX($status);
												if (!empty($rows)) {
													foreach ($rows as $row) {
