								...
								<div class="ttr-box portfolio-bx">
									<div class="ttr-media media-ov2 media-effect">
										<a href="javascript:void(0);">
											<img src="assets/images/feedbacks/<?php echo $row['image_unique']; ?>.jpg" alt="" style="width: 262.5px; height: 262.5px; object-fit: cover;"> 
										</a>
										<div class="ov-box">
											<div class="overlay-icon align-m"> 
												<a href="assets/images/feedbacks/<?php echo $row['image_unique']; ?>.jpg" class="magnific-anchor" title="Title Come Here">
													<i class="ti-search"></i>
												</a>
											</div>
											<div class="portfolio-info-bx bg-primary">
												<h4><a href=""><?php echo $row['feedback']; ?></a></h4>
											</div>
										</div>
									</div>
								</div>
