			...
			<div class="container-fluid">
				<div class="db-breadcrumb">
					...
					<ul class="db-breadcrumb-list">
						<li><i class="ti-announcement"></i>Archived Services</li>
					</ul>
				</div>  
				...
				<div class="row">
					<div class="col-lg-12 m-b30">
							...
							<div class="heading-bx left">
								<h2 class="m-b10 title-head">Archived <span>Services</span></h2>
							</div>
								<?php
									$category = 1;
									$status = 2;
										...
										<tbody>
											...
											<?php 
												...
												if (isset($_POST['archive'])) {
													...
													echo "<script>window.open('archived-services', '_self');</script>";
												}
								...
								<hr>
								<div align="right">
									<a href="services" class="btn blue radius-xl" style="float: right;background-color: <?php echo $primary_color; ?>"><i class="ti-list"></i><span>&nbsp;SERVICES</span></a><br>
								</div>
