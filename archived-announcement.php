				...
				<div class="row">
					<div class="col-lg-12 m-b30">
							...
							<div class="heading-bx left">
								<h2 class="m-b10 title-head">Archived <span>Announcements</span></h2>
							</div>
								<?php
									$category = 0;
									$status = 2;
								...
								<hr>
								<div align="right">
									<a href="announcement" class="btn blue radius-xl" style="float: right;background-color: <?php echo $primary_color; ?>"><i class="ti-announcement"></i><span>&nbsp;ANNOUNCEMENTS</span></a><br>
								</div>
