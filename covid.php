		...
		<main class="ttr-wrapper" style="background-color: #FBFBFB;">
			<div class="container-fluid">
				<div class="db-breadcrumb">
					<h4 class="breadcrumb-title">Procedure</h4>
					<ul class="db-breadcrumb-list">
						<li><i class="ti-list"></i>Covid Symptoms</li>
					</ul>
				</div>  
				...
				<div class="row">
					<div class="col-lg-12 m-b30">
							...
							<div class="heading-bx left">
								<h2 class="m-b10 title-head">Procedure <span>cannot proceed because the patient's Health Declaration Form matches COVID-19 Sysmptoms.</span></h2>
							</div>
