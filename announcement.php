				...
				<div class="row">
					<div class="col-lg-12 m-b30">
							...
							<div class="heading-bx left">
								<h2 class="m-b10 title-head">Announcements <span></span></h2>
							</div>
								...
								<div align="right">
									...
									<a href="" class="btn green radius-xl" data-toggle="modal" data-target="#add-announcement" style="background-color: <?php echo $primary_color; ?>"><i class="ti-announcement"></i><span>&nbsp;ADD NEW ANNOUNCEMENT</span></a>&nbsp;&nbsp;<a href="archived-announcement" class="btn red radius-xl"><i class="ti-archive"></i><span>&nbsp;ARCHIVED ANNOUNCEMENTS</span></a>
								</div>
